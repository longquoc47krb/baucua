...
function BettingZone({ item }: BettingZoneProps) {
    ...
    // bg-[#faefdb]
    const bettingClass = classNames('relative p-4 bg-[#faefdb] border-4 border-[#eabd68] w-[280px] flex items-center flex-col min-h-[43vh]', renderBackground());
    return (
        <div className={bettingClass}>
            ...
            <img src={item.path} className='w-[20vh] h-[20vh] cursor-pointer' />
            {
